...
(yas-define-snippets 'ruby-mode
                     '(("#" "# => " "# =>" nil
                       ...
                       ("aa.accessor" "attr_accessor :${instance_valiable}" "attr_accessor" nil nil nil nil nil nil)
                       ...
                       ("cxt" "context '${string}' do\n  $0\nend\n" "context '' do ... end" nil nil nil nil nil nil)
                       ...
                       ("eawi" "each_with_index { |${e}, ${i}| $0 }" "each_with_index { |e, i| ... }" nil
                        ("collections")
                        nil nil nil nil)
                       ("ent" "expect(${something}).not_to $0\n" "expect.not_to" nil nil nil nil nil nil)
                       ("ept" "expect(${page}).to $0\n" "expect.to" nil nil nil nil nil nil)
                       ("et" "expect(${something}).to $0\n" "expect.to" nil nil nil nil nil nil)
